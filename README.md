...
| **Issue Reviewer** | Reviews issues and epics, researches complex topics, answers open questions, and rewrites issue trees into implementation-ready plans for a coding agent |
...
The **Issue Reviewer** runs before coding when you want the issue tree tightened for implementation: it reads an issue tree, researches complex topics, answers open questions, rewrites acceptance criteria, and reshapes sub-issues until the plan is explicit enough for a coding agent to implement. Unless you say otherwise, the workflow assumes coding comes next.
...
| **Issue Reviewer** | `.github/agents/issue-reviewer.agent.md` | Implementation-prep agent. Reads issues and sub-issues, researches complex topics, resolves technical questions, and rewrites issue trees into coding-ready plans. |
...
| **Issue Review Workflow** | `.github/skills/issue-review-workflow/SKILL.md` | Issue and epic review for coding-agent handoff using architect -> engineer -> writer passes, recursive sub-issue review, complexity-triggered web research, and iterative issue updates until stable. |
...
| **review-issue** | `.github/prompts/review-issue.prompt.md` | Review an issue or epic before coding: inspect sub-issues recursively, research complex topics, answer open questions, and rewrite the issue tree into an implementation-ready plan for a coding agent. |
